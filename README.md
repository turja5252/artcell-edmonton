...
- **MC** — Show MC run-of-show for Tanzim (TN) and Rowshon (RS): chapter cues, speakable scripts (including Dhaka Archive Bangla), sponsor glance list, and thanks. Tap **Edit** on a cue to change the line, slide the grip to reorder, and tap **TN / Rowshon / Both** to switch who speaks — those saves are shared on both phones. Ticks stay on this phone only.
